  ...
  <Popup :open="popupOpen">
    ...
    <template v-slot:content>
      ...
      <div class="text-center">
        <div role="status">
          <svg class="inline m-6 w-16 h-16 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
