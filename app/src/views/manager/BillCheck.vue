...
<!--            <p v-else class="bg-red-500 text-white text-center">ไม่ว่าง</p>-->
      ...
      <Popup :open="isTableDetailOpen">
        ...
        <template v-slot:content>
          <p>จำนวนลูกค้า {{ this.selectedTable.size }} คน</p>
          <p v-if="this.selectedTable.status === 0">สถานะ : ไม่ว่าง</p>
          <p v-if="this.selectedTable.status === 0">รหัส : {{ this.customer.code }}</p>
        </template>
